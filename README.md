...
This repository contains the code and processed analysis assets for the manuscript **"Inferring disruption of directed graphs using LIKA reveals altered protein phosphorylation networks in schizophrenia."** LIKA infers kinase dysregulation from phosphoproteomic data while accounting for many-to-many kinase-substrate annotations.

## Repository Layout

- `src/`: LIKA implementation, statistical methods, and simulation code.
...
Run the schizophrenia analysis:
...
The kinase-substrate network is derived from the KSEA resource. Add the schizophrenia phosphoproteomics accession or controlled-access statement before journal release.
